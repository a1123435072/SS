 ...
 */
public class CommonSpanBuilder extends SpannableStringBuilder {

    private int flag = Spannable.SPAN_EXCLUSIVE_EXCLUSIVE;

    public CommonSpanBuilder() {
        super("");
    }

    public CommonSpanBuilder(CharSequence text) {
        super(text);
    }

    public CommonSpanBuilder(CharSequence text, Object... spans) {
        super(text);
    ...
    public CommonSpanBuilder(CharSequence text, Object span) {
        super(text);
     ...
     * @return this {@code CommonSpanBuilder}.
     */
    public CommonSpanBuilder append(CharSequence text, Object... spans) {
        append(text);
        for (Object span : spans) {
    ...
    public CommonSpanBuilder append(CharSequence text, Object span) {
        append(text);
        setSpan(span, length() - text.length(), length());
        return this;
    }
     ...
     * @return this {@code CommonSpanBuilder}.
     */
    public CommonSpanBuilder append(CharSequence text, ImageSpan imageSpan) {
        text = "." + text;
        append(text);
     ...
     */
    @Override
    public CommonSpanBuilder append(CharSequence text) {
        super.append(text);
        return this;
    }
     ...
     */
    @Deprecated
    public CommonSpanBuilder appendText(CharSequence text) {
        append(text);
        return this;
    }
     ...
     * @return {@code CommonSpanBuilder}.
     */
    public CommonSpanBuilder findAndSpan(CharSequence textToSpan, GetSpan getSpan) {
        int lastIndex = 0;
        while (lastIndex != -1) {
    ...
    /**
     * Sets span objects to the text. This is more efficient than creating a new instance of CommonSpanBuilder
