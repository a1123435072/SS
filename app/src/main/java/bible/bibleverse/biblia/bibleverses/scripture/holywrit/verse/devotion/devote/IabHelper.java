...
public class IabHelper {
    ...
    int queryPurchases(Inventory inv, String itemType) throws JSONException, RemoteException {
        ...
        do {
            ...
            logDebug("INAPP ownedSkus size: " + ((ownedSkus == null) ? "0" : ownedSkus.size()));
            ArrayList<String> purchaseDataList = ownedItems.getStringArrayList(
                    RESPONSE_INAPP_PURCHASE_DATA_LIST);
            logDebug("INAPP purchaseDataList size: " + ((purchaseDataList == null) ? "0" : purchaseDataList.size()));
            ArrayList<String> signatureList = ownedItems.getStringArrayList(
                    RESPONSE_INAPP_SIGNATURE_LIST);
            logDebug("INAPP signatureList size: " + ((signatureList == null) ? "0" : signatureList.size()));
    ...
    int querySkuDetails(String itemType, Inventory inv, List<String> moreSkus)
        ...
        logDebug("queryPrices skuList:" + skuList.size() + " itemType:" + itemType);
        if (moreSkus != null) {
