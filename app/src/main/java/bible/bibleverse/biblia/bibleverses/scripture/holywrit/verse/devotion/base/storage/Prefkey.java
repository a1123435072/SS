...
public enum Prefkey {
	...
	/** Search history (JSON: {@link bible.bibleverse.biblia.bibleverses.scripture.holywrit.verse.devotion.base.ac.SearchActivity.SearchHistory}) */
	searchHistory,
	 ...
	 * For {@link bible.bibleverse.biblia.bibleverses.scripture.holywrit.verse.devotion.base.model.MVersionDb}, the ordering is stored in a table on the database.
	 * However for internal version, the ordering is stored in the preferences.
	 * Default is {@link bible.bibleverse.biblia.bibleverses.scripture.holywrit.verse.devotion.base.model.MVersionInternal#DEFAULT_ORDERING}.
	 */
