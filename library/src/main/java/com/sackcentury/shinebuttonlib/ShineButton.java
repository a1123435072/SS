...
public class ShineButton extends PorterShapeImageView {
    ...
    public void setAnimListener(Animator.AnimatorListener mAnimListener) {
        this.mAnimListener = mAnimListener;
    }

    private Animator.AnimatorListener mAnimListener;

    private long mAnimDelay = 180;

    public void setAnimDelay(long mAnimDelay) {
        this.mAnimDelay = mAnimDelay;
    }
    ...
    public void setChecked(boolean checked, boolean anim) {
        ...
        onCheckedListenerUpdate(checked);
    }
    ...
    private void onCheckedListenerUpdate(boolean checked) {
    ...
    private void doShareAnim() {
        ...
        shakeAnimator.setStartDelay(mAnimDelay);
        invalidate();
        ...
        if (mAnimListener != null) {
            shakeAnimator.addListener(mAnimListener);
        }
...
//                setCancel();
//            }
//            onCheckedListenerUpdate(isChecked);
            if (listener != null) {
