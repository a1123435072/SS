 ...
 * </p>
 */
public abstract class OmAsyncTask<Params, Progress, Result> {
	private static final String LOG_TAG = "AsyncTask";

	private static final int CPU_COUNT = Runtime.getRuntime().availableProcessors();
	private static final int CORE_POOL_SIZE = CPU_COUNT + 2;//+ <from 1 to 2>
	private static final int MAXIMUM_POOL_SIZE = CPU_COUNT * 2 + 10;//+ <from 1 to 10>
	 ...
	 *             {@link utils.OmAsyncTask.Status#RUNNING} or
	 *             {@link utils.OmAsyncTask.Status#FINISHED}.
	 *
	 * @see #executeOnExecutor(Executor, Object[])
	 * @see #execute(Runnable)
	 */
	public final OmAsyncTask<Params, Progress, Result> execute(Params... params) {
//		return executeOnExecutor(sDefaultExecutor, params);
	 ...
	 * @see #execute(Object[])
	 */
	public final OmAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec, Params... params) {
	...
	private static class AsyncTaskResult<Data> {
		final OmAsyncTask mTask;
		final Data[] mData;

		AsyncTaskResult(OmAsyncTask task, Data... data) {
			mTask = task;
			mData = data;
		}
	}
