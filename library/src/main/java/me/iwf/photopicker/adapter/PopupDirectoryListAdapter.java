...
public class PopupDirectoryListAdapter extends BaseAdapter {
    ...
    public PopupDirectoryListAdapter(Context context, List<PhotoDirectory> directories) {
        ...
        imageSize = context.getResources().getDimensionPixelSize(R.dimen.__picker_item_directory_height);
    }
    ...
    private class ViewHolder {
        ...
        public void bindData(PhotoDirectory directory) {
            Picasso.with(tvCount.getContext()).load("file://" + directory.getCoverPath()).resize(imageSize, imageSize).into(ivCover);
